  ...
  return(
    <>
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <h5 className='fw-bold'>Dr. Tri Hatmoko Ananto</h5>
    ...
    <div className='container mt-4'>
      <div className='row'>
        <div className='col-sm-12'>
          <h4 className='fw-bold'>Dokter Rekomendasi Untuk Kamu</h4>
        </div>
      </div>
    </div>
    <div className='mt-2'>
        ...
        <div className='col-lg-3 col-md-6 col-sm-12 mb-4 d-flex justify-content-center'>
          <Card border="light" className='bayangan kartu' style={{ width: '16rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Title className='fw-bold'>Dr. Septina Wardani</Card.Title>
        ...
        <div className='col-lg-3 col-md-6 col-sm-12 mb-4 d-flex justify-content-center'>
          <Card border="light" className='bayangan kartu' style={{ width: '16rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Title className='fw-bold'>Dr. Reni Alya</Card.Title>
        ...
        <div className='col-lg-3 col-md-6 col-sm-12 mb-4 d-flex justify-content-center'>
          <Card border="light" className='bayangan kartu' style={{ width: '16rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Title className='fw-bold'>Dr. Eni Sagita</Card.Title>
        ...
        <div className='col-lg-3 col-md-6 col-sm-12 mb-4 d-flex justify-content-center'>
          <Card border="light" className='bayangan kartu' style={{ width: '16rem' }}>
            ...
            <Card.Body>
              <div className='row'>
                <div className='col-12'>
                <small className='text-info fw-bold'><i class="fa-solid fa-stethoscope me-2"></i>Spesialis Gigi</small>
                </div>
              </div>
              <Card.Title className='fw-bold'>Dr. Yeni Inka</Card.Title>
              <small className='text-muted'><i class="fa-solid fa-location-dot me-2"></i>Klinik Panasea, Caruban</small>
              <Button variant="info" className='text-light col-12 mt-2' size='sm' onClick={handleShow}>Buat Janji</Button>
            </Card.Body>
          </Card>
